...
def login_way_chooser(is_old: bool) -> str:
    ...
    setup_way_chooser_keyboard.add_text_button(text=CommandsOfVK.LOGIN_BB.value, payload={ "callback": Command.LOGIN_BB.value })
    
    setup_way_chooser_keyboard.add_row()
    setup_way_chooser_keyboard.add_text_button(text=CommandsOfVK.LOGIN_COMPACT.value, payload={ "callback": Command.LOGIN_COMPACT.value })    
...
def againer() -> str:
    ...
    againer_keyboard.add_text_button(text=CommandsOfVK.CONTINUE.value, payload={ "callback": Command.LOGIN_COMPACT.value })
