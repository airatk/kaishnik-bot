...
def institute_setter():
    ...
    institute_setter_keyboard.add(*[ KeyboardButton(text=institute) for institute in INSTITUTES ])
...
def year_setter(years):
    ...
    year_setter_keyboard.add(*[ KeyboardButton(text=year) for year in years ])
...
def group_number_setter(groups):
    ...
    group_number_setter_keyboard.add(*[ KeyboardButton(text=group) for group in groups ])
...
def name_setter(names):
    ...
    name_setter_keyboard.add(*[ KeyboardButton(text=name) for name in names ])
