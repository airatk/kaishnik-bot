...
HELP = (
    ...
    "\n*classes & exams*\n"
    "• Для того, чтобы узнать расписание занятий другой группы, введи */classes [ номер группы ]*\n"
    "• То же работает с */exams*\n"
    
    "\n*score*\n"
    "• Можно ввести */score экзамены*, */score зачёты* или */score зачёты с оценкой* и "
    "увидеть баллы за семестр лишь по соответствующим предметам.\n"
    ...
    "\n*другое*\n"
    "• Внутри бота реализована GS-система, которая не позволяет отправить вторую команду пока выполняется первая. "
...
LOADING_REPLIES = [
    ...
    REPLIES_TO_UNKNOWN_MESSAGE[8] + "\n\n" + "ожидание ответа от серверов kai.ru…"
]

GUIDE_MESSAGE = REPLIES_TO_UNKNOWN_COMMAND[0]
